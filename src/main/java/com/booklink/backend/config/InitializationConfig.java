...
public class InitializationConfig implements CommandLineRunner {
    ...
    private void loadUsers(){
        ...
        private void loadForums(){
            ...
            Forum forum1 = Forum.builder().name("Harry Potter").userId(user1.getId()).description("foro acerca de la mejor saga de libros jamas escrita: Harry Potter").img("https://images2.minutemediacdn.com/image/upload/c_crop,w_5211,h_2931,x_0,y_392/c_fill,w_720,ar_16:9,f_auto,q_auto,g_auto/images/GettyImages/mmsport/90min_es_international_web/01h7tmmpt0k2z8a5nnep.jpg").members(usuarios1).build();
            Forum forum2 = Forum.builder().name("Narnia").userId(user2.getId()).description("foro sobre Narnia, tocamos todo tipo de temas acerca de este libro, desde debate acerca de los reyes, teorias conspirativas y mas").img("https://images2.minutemediacdn.com/image/upload/c_crop,w_5211,h_2931,x_0,y_392/c_fill,w_720,ar_16:9,f_auto,q_auto,g_auto/images/GettyImages/mmsport/90min_es_international_web/01h7tmmpt0k2z8a5nnep.jpg").members(usuarios1).build();
            Forum forum3 = Forum.builder().name("1984").userId(user3.getId()).description("Nos remitimos a un clásico no solo para habar de él libro en si, sino tambien para reflexionar acerca del mundo en la actualidad").img("https://images2.minutemediacdn.com/image/upload/c_crop,w_5211,h_2931,x_0,y_392/c_fill,w_720,ar_16:9,f_auto,q_auto,g_auto/images/GettyImages/mmsport/90min_es_international_web/01h7tmmpt0k2z8a5nnep.jpg").members(usuarios5).build();
            ...
            Forum forum5 = Forum.builder().name("los mejores libros de ciencia ficcion").userId(user5.getId()).description("En este foro somos apasionados de la ciencia ficción.Aca hablamos sobre sus mejores obras, novelas y autores.Todos son bienvenidos a opinar ").img("https://images2.minutemediacdn.com/image/upload/c_crop,w_5211,h_2931,x_0,y_392/c_fill,w_720,ar_16:9,f_auto,q_auto,g_auto/images/GettyImages/mmsport/90min_es_international_web/01h7tmmpt0k2z8a5nnep.jpg").members(usuarios5).build();
